...
public class Utility {
    ...
    public static void setNewTask(int _TASK_ID,String _Title, String _ImageUrl,String _Description,Date _EndDate,String _StartDate,String _Time,int CATEGORY_ID,int _Duration) {
        newTask.add(new Task(_TASK_ID, _Title,  _ImageUrl, _Description, _StartDate,_EndDate, _Time,CATEGORY_ID,_Duration));
    }
    ...
    private static void initAllCategory() {
       String Name="Work";
       int image =R.drawable.farmland;
       int background = R.drawable.weekday_back;



        AllCategories.add(new Category(CATEGORY_ID, Name,image,background));
    ...
    private static void initAllTask() {
        ...
        String Description = "mow the lawn before 5pm";
        Date EndDate = new Date(123, 9,24);
        ...
        newTask.add(new Task(TASK_ID, Title, ImageUrl,Description,StartDate,EndDate,Time,CategoryId,Duration));

         Title="Homework";
         ImageUrl = "https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcTJ2HCQwNOetaK7RAV-XTjKdwNsOlGce2D_QljqHUMI&s";
         Description = "It Time i do my HomeWork";
         EndDate = new Date(123, 10,11);
        ...
        Description = "Its time if do the diches today";
        EndDate =  new Date(123, 11,06);
